...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public void deletetype(Long userId) {
		sysUserDao.deletetype(userId);
	}

	@Override
	public SysUserEntity checkuser(String username) {
		return sysUserDao.checkuser(username);
	}

	@Override
	public SysUserEntity checkemail(String mail) {
		return sysUserDao.checkemail(mail);
	}

	@Override
	public int updatepass(SysUserEntity user) {
		return sysUserDao.updatepass(user);
	}

	@Override
	public int lineTotal() {
		return sysUserDao.lineTotal();
	}

	@Override
	public int linesTotal() {
		return sysUserDao.linesTotal();
	}

	@Override
	public int updateline(SysUserEntity user) {
		return sysUserDao.updateline(user);
	}

	@Override
	public int updateurl(SysUserEntity user) {
		return sysUserDao.updateurl(user);
	}
}
